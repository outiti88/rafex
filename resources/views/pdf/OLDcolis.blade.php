            ...
            <div class="container page-break" >
                ...
                <div style="padding-top:2px;">
                    <div class="logo-text" style="float: left" >
                        @if ($size == 'A6')
                            <img src="assets/images/logo-hori.png" style=" WIDTH: 90PX;"class="light-logo" alt="homepage" />
                        @else
                            <img src="assets/images/logo-light-text.png" style=" WIDTH: 50PX;"class="light-logo" alt="homepage" />
                        @endif
                    </div>
                </div>
                @if ($size == 'A6')
