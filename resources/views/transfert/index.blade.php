...
<div class="page-breadcrumb">
    <div class="row align-items-center">
        <div class="col-5">
            <h4 class="page-title">Gestion des demandes de transferts</h4>
                                ...
                                <div class="modal-dialog" role="document">
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-body mx-3">
                                        <form class="form-horizontal form-material" method="GET" action="{{route('transfert.filter')}}">
                                            @csrf
...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="collapse show" id="mycard-collapse" style="width : 100%;">
            <div class="card-body">
              <div class="row" style="display: flex;align-items: center;align-content: stretch;flex-wrap: wrap;justify-content: space-evenly">
                    ...
                    <a  href="/transferts/filter?statut=Nouvelle" style="display:block ; margin: 0.5rem; font-size: 0.8em;padding: 1rem !important;color: white; cursor:pointer;margin-top:0.5rem" class="badge badge-secondary">
                      <span>Nouvelle</span>
                    </a>
                    <a  href="/transferts/filter?statut=Envoyée" style="display:block ; margin: 0.5rem; font-size: 0.8em;padding: 1rem !important;color: white; cursor:pointer;margin-top:0.5rem" class="badge badge-success">
                      <span>Envoyée</span>
                    </a>
                    <a  href="/transferts/filter?statut=Reçue" style="display:block ; margin: 0.5rem; font-size: 0.8em;padding: 1rem !important;color: white; cursor:pointer;margin-top:0.5rem" class="badge badge-primary cielBadge">
                      <span>Reçue</span>
                    </a>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Gérer vos demandes de transferts</h4>
                ...
                <div class="table-responsive">
                    <table class="table table-hover table-bordered" style="font-size: 0.85em;">
                        ...
                        <tbody>
                            @forelse ($transferts as $index => $transfert)
                                <tr>
                                    ...
                                    <td>
                                        {{$transfert->validate_at}}</td>
                                    <td>{{$transfert->received}}</td>
                                    <td>{{App\User::where('id',$transfert->user_id)->first()->name}}</td>
                                    <td>
                                    ...
                                    <td>
                                        <span style="color : white"       @switch($transfert->statut)
                                            @case("Nouvelle")
                                            class="badge-pill badge badge-secondary"
                                            @break
                                            @case("Envoyée") class="badge badge-pill badge-success" @break
                                    ...
                                    <td style="font-size: 1.5em">
                                        <a style="color: #467a0f" href="/transfert/{{$transfert->id}}">
...
<div class="container my-4">
    <div class="modal fade" id="modalAddTransfert" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form class="form-horizontal form-material" method="POST" action="{{route('transfert.store')}}">
                    @csrf
                    <div class="modal-header text-center">
                        <h4 class="modal-title w-100 font-weight-bold">Ajouter une demande de transfert</h4>
