                        ...
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="" width="100%">
                          <tr>
                            <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                              <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:20px;line-height:1;text-align:center;color:#467a0f;"><strong>Bonjour {{$details['user']->name}}</strong></div>
                            </td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            ...
                            <div style="font-family:Arial, sans-serif;font-size:25px;font-weight:bold;line-height:35px;text-align:center;color:#467a0f;">Facture <strong>N°:{{$details['facture']->numero}}</strong> <br> <span style="font-size:18px">Du: {{$details['facture']->created_at}}</span></div>
                            </td>
                          </tr>
                          <tr>
                            <td align="center" vertical-align="middle" style="font-size:0px;padding:20px 0 0 0;word-break:break-word;">
                              <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;line-height:100%;">
                                <tr>
                                <td align="center" bgcolor="#8bb420" role="presentation" style="border:none;border-radius:3px;cursor:auto;mso-padding-alt:10px 25px;background:#467a0f;" valign="middle"> <a href="{{route('facture.gen',$details['facture']->id)}}"style="display: inline-block; background: #467a0f; font-family: Arial, sans-serif; font-size: 16px; font-weight: bold; line-height: 120%; margin: 0; text-transform: none; padding: 10px 25px; mso-padding-alt: 0px; border-radius: 3px; text-decoration: none; color: white;"
                                      target="_blank">
