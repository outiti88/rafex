...
class DiffTest extends AbstractTestCase
{
    ...
    public function testFloatDiff()
    {
        ...
        $this->assertSame(1.0006dcdc3a444443, Carbon::parse('2018-12-01 00:00')->floatDiffInDays(Carbon::parse('2018-12-02 00:01')));
        $this->assertSame(1.0006dcdc3a444443 / 7, Carbon::parse('2018-12-01 00:00')->floatDiffInWeeks(Carbon::parse('2018-12-02 00:01')));
    ...
    public function testFloatDiffWithRealUnits()
    {
        ...
        $this->assertEqualsWithDelta(1.0006dcdc3a444443, Carbon::parse('2018-12-01 00:00')->floatDiffInRealDays(Carbon::parse('2018-12-02 00:01')), 0.0000000001);
        $this->assertEqualsWithDelta(1.0006dcdc3a444443 / 7, Carbon::parse('2018-12-01 00:00')->floatDiffInRealWeeks(Carbon::parse('2018-12-02 00:01')), 0.0000000001);
